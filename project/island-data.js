...
window.DATA = {
  works: [
    { id:'w1', title:'ケーブル編みセーター', en:'Cable Sweater', category:'ウェア', status:'done',
      ...
      knit:'#ece1cb', emoji:'🧥', ac:'ac-flower',
    ...
    { id:'w5', title:'ふわもこマフラー', en:'Fluffy Muffler', category:'こもの', status:'plan',
      ...
      knit:'#f2dde2', emoji:'🧣', ac:'ac-flower',
